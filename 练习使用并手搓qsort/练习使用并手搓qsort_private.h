...
#ifndef 练习使用并手搓qsort_private_rc
#define 练习使用并手搓qsort_private_rc
...
#define ORIGINAL_FILENAME	"练习使用并手搓qsort.exe"
#define PRODUCT_NAME	"练习使用并手搓qsort"
#define PRODUCT_VERSION	"0.1.1.1"

#endif /*练习使用并手搓qsort_private_rc*/
